...
* hanke: (server) Tokenizing completely rewritten. Indexing and querying now only differ in where they downcase (indexing very early, querying rather late). Note that in querying you should use
