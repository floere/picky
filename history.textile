 ...
 * hanke: (server) New :from option. Assume you have a source @Sources::CSV.new(:title, file:'some_file.csv')@ but you want the category to be called differently. The you use from: @define_category(:similar_title, :from => :title)@.
 * hanke: (server) CSV source uses FasterCSV with all its options (col_sep, row_sep et cetera).
