h2. Version 1.3.0 (unreleased)

 * hanke: (server) Offers a new routing API, an interface that permits changing parameters in the running server. Use like @route %r{/admin} => Live::Interface.new@.
