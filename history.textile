...
* hanke: (server) Unified tokenizers. Method @#tokenize(text)@ now returns @[ ["token", "token", "token"], ["Original", "Original", "Original"] ]@.
* hanke: (server) Removed tokenizer option @removes_characters_after_splitting: /soem regexp/@ (without replacement).
