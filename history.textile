...
* hanke: (server) @default_indexing@ and @default_querying@ offer a new option, @case_sensitive@, which is by default @false@. Set it in indexing and querying to @true@ to have your search be case sensitive. Watch the regexp options – possibly best if you set them to case insensitive @/…/i@.
