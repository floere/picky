...
* hanke: (server) Possible solution to "Issue 32":http://github.com/floere/picky/issues/32. *Please take note when updating to this version: This version forks even with a single index (Windows users and users who had problems with forking and single indexes)!*
