...
Example:
You search for @"picky search"@. And you find it in two allocations, @name, type@ and @name, name@. Let's say Picky finds ids @[1, 2, 3]@
in @name, type@ and then @[2, 3, 4]@
in @name, name@. Picky will then remove @2 and 3@ from @name, name@ because they have been found in @name, type@ already.
