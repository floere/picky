h2. Version 2.0.0.pre3 (unreleased)

* hanke: (server) Renamed @Similarity::DoubleLevenshtone@ (aka @Similarity::Phonetic@) to @Similarity::DoubleMetaphone@ (BREAKING: Do not use @Similarity::Phonetic@ anymore).
