...
* hanke: (server) Added @Index#facets(:category_name, minimum_weight = nil)@. Will return keys and weights.
...
* hanke: Usage – @products.facets :brand_name, filter: 'category:boots', more_than: 0@.
