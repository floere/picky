...
* hanke: (server) Possible solution to "Issue 32":http://github.com/floere/picky/issues/32. The issue is possibly related to http://redmine.ruby-lang.org/issues/5003. *Please take note when updating to this version: This version forks even with a single index (Sorry, Windows users – please notify me)!*
