 ...
 * hanke: (statistics) (BETA) New statistics gem for Picky. Run @picky stats path/to/your/search.log [port]@ in your Picky Server directory to start a statistics server. Go to "http://localhost:4567":http://localhost:4567 after running the command to take a look.
