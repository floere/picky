...
* hanke: (client javascript files) Replace your javascript file with the new ones in @picky/generators/prototypes/client/sinatra/javascripts/*.js@.
* hanke: (client) Added @rake javascripts@ to the client and client project generator which copies the latest javascripts into your directory (if they don't exist yet)
