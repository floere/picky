...
* hanke: (server) Get Indexes/Categories using the @#[]@ method. E.g. @Indexes[:books]@ to get the @:books@ index, and @Indexes[:books][:title]@ to get the @:title@ category of the @:books@ index.
