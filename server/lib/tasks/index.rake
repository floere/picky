...
namespace :index do
  ...
  desc "E.g. index:only[books,title]. Generates a specific index table. Note: temp tables need to be there. Will generate just the index table."
  ...
  desc "E.g. index:specific[books,title]. Generates a specific index cache file. Note: temp tables need to be there. Will generate index table and cache."
  ...
  desc "TODO: E.g. index:try[some_text,field_name]. Try how a given word would be indexed. Field name is optional."
