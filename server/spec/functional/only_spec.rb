...
describe 'Search#only' do
  ...
  it 'offers the option only' do
    ...
    try_again.search('text1:text2').ids.should == []
    try_again.search('text1:text3').ids.should == []
    
    try_again.search('text2:text1').ids.should == []
    try_again.search('text2:text2').ids.should == [1]
    try_again.search('text2:text3').ids.should == []
    
    try_again.search('text3:text1').ids.should == []
    try_again.search('text3:text2').ids.should == []
