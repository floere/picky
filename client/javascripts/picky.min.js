...
function(b,n,A,x){var z=j(n,x);if(z!=undefined)n=z;s=[b,n,A,x];z=n;if(z!=f()){z=z==""?"":"?q="+escape(z).replace(/\*/g,"%2A");window.History&&window.History.getState()&&window.History.pushState&&window.History.pushState(null,null,z)}if(!r&&n=="")c.reset();else(b=i[b])&&b.search(n,A,x)};this.resend=function(){s&&d.apply(this,s)};var h=function(b,n){b=k(b,n)||b;c.fullResultsCallback(b);p(b,n)},m=function(b,n){clearInterval(e);d("full",b,h,n||{})};a=function(b,n){b=k(b,n)||b;c.liveResultsCallback(b);
